...
![GitHub Downloads (all releases)](https://img.shields.io/github/downloads/rune-goblin/footsteps-and-maps/total?include_prereleases&filter=*.zip)
...
![a mossy skull](readme/mossy-skull.webp)
...
![control ui](readme/control-ui.webp)

**NPC Map Journals**
Journal Handouts for maps that can be provided by NPCs

Boss Skrawg – Inspired by DMSteve, https://www.recallknowledge.com/
![a crude map](readme/boss-skrawg-map.webp)

Graulgust's sketch
![a rough sketch](readme/graulgust-sketch.webp)

Volluk's Desk - blueprints of levels 1-3
![blueprints of the first three levels](readme/volluk-blueprints.webp)

**Tokens**
- Top down tokens for these NPCs: C1-Augrael, D8-Volluk, and D9-LasdaVenkervale
![preview of token images](readme/npc-tokens.webp)

Hazard tokens for the BrownMold(B20) and Hall of Hatred(B29)
![circular images for hazards](readme/hazard-tokens.webp)

**Area Map for Wrin's Wonders**

![a tent by the river](readme/wrins-wonders.webp)
